...
describe.only('Jupyter checkpoints deletion', async () => {
    ...
    it('is disabled by default', async () => {
        ...
        expect(checkpointsFolderExists).toBe(true, `Jupyter checkpoints folder should still exist after stopping the server but was removed`);
    });
    ...
    it('can be enabled in the settings', async () => {
        ...
        expect(checkpointsFolderExists).toBe(false, `Jupyter checkpoints folder should not exist after enabling deletion but was created`);
    });
});