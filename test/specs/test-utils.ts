 ...
 */
export async function getFileTreeItem(path: string, browser: Browser & ObsidianBrowserCommands): Promise<ChainablePromiseElement> {
 ...
 */
export async function resetVaultWithSettings(obsidianPage: ObsidianPage, value: Partial<JupyterSettings>): Promise<void> {
